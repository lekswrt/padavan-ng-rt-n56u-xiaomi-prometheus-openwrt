...
#if defined(CONFIG_MEDIA_CONTROLLER_DVB) || defined(CPTCFG_MEDIA_CONTROLLER_DVB)
			  ...
			  struct dvb_frontend* fe)
{
	...
	dvb_register_device (fe->dvb, &fepriv->dvbdev, &dvbdev_template, fe,
#if LINUX_VERSION_CODE < KERNEL_VERSION(4, 5, 0)
			     DVB_DEVICE_FRONTEND);
#else
...
#if defined(CONFIG_MEDIA_ATTACH) || defined(CPTCFG_MEDIA_ATTACH)
